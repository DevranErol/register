...
if(!['761571144263925787'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '♠'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '761571144272576554') 
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '761571144263925788')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '761571144155004931')
const genelchat = message.guild.channels.cache.find(c => c.id === '761571146482319397')
const savelog = message.guild.channels.cache.find(c => c.id === '761571144725692466')
